...
| **macOS / Linux** | Собрать самостоятельно с помощью Nativefier:<br><br>```bash<br>npm install -g @gwicho38/nativefier<br>nativefier "https://sementsul.github.io/GitDOS" --platform mac   # или linux<br>``` |
