...
| **macOS / Linux** | Собрать самостоятельно с помощью Nativefier:\ 
```bash npm install -g @gwicho38/nativefier             nativefier "https://sementsul.github.io/GitDOS" --platform mac   # или linux<br>``` |
